...
map.getView().fit([663556.281385, 5565523.645262, 805759.718550, 5660349.577064], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Le Brianconnais</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (46 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Source : ©OSM contributors/ BDtopo2024 Sig\'Alp';
            }
